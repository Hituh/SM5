...
public class SensorActivity extends AppCompatActivity {
    ...
    private String KEY_SUBTITLE_VISABILITY = "SensorApp.subtitle_visible";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null){
            subtitleVisible = savedInstanceState.getBoolean(KEY_SUBTITLE_VISABILITY);
        }
    ...
    public void onSaveInstanceState(Bundle outState){
        ...
        outState.putBoolean(KEY_SUBTITLE_VISABILITY, subtitleVisible);
    }
    ...
    private class SensorHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void bind(Sensor sensor){
            ...
            if (Sensor.TYPE_GRAVITY == sensor.getType() || Sensor.TYPE_MAGNETIC_FIELD == sensor.getType() || Sensor.TYPE_MAGNETIC_FIELD_UNCALIBRATED == sensor.getType()) {
